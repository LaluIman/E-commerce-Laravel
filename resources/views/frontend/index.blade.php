        ...
        <div class="flex flex-wrap items-center justify-between w-full gap-8">
            <div class="w-full max-w-[400px] flex flex-col gap-4">
                <div class="inline-flex gap-[6px] items-center bg-lavender-pink rounded-full px-4 py-[6px] w-max">
                    <img draggable="false" src="{{ asset('assets/svgs/logo-mark.svg') }}" alt="tickety-assets">
            ...
            <img draggable="false" src="{{ asset('assets/images/bro.png') }}" class="w-[23rem] md:w-[30rem] h-[29rem ]"
                alt="tickety-assets">
        </div>
    </section>
    {{-- wave --}}
    <img draggable="false" src="{{ asset('assets/svgs/wavy-line-1.svg') }}" class="absolute -z-10 md:top-[160px] w-full"
            alt="tickety-assets">
    {{-- event section --}}
      ...
      @endif
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
            ...
            @foreach ($events as $event)
                ...
                :price="$event->start_from" :description="$event->headline" :isPopular="$event->is_popular" :route="route('detail', $event->slug)"/>
                </div>
            @endforeach
        </div>
    </section>
