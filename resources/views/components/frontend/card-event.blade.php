...
<div class="group rounded-2xl w-full overflow-hidden relative min-h-[297px] bg-primary">
    <!-- Popular badge -->
    @if($isPopular)
    <p class="px-[14px] py-2 rounded-xl bg-yellow-500 text-white font-semibold text-sm absolute top-5 right-5">
        Popular
    </p>
    @endif
    ...
    <div
        ...
        <div class="flex flex-wrap items-center justify-between gap-y-4">
            <div class="max-w-[180px]">
                ...
                <p class="text-pastel-purple text-sm mt-[6px] capitalize">
